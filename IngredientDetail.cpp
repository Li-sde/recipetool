/**
 * @brief This class represents the ingredient detailed window with its amount and nutrition, and allows user to edit the amount
 * @author Xingjian Mao
 * @date 2021/11/30
 */
...
/**
 * @brief This is the constructor of the class, it take the ingredinet id and the target database
 * and creates a detailed window
 * @param IngIDp stirng represents the ingredient id
 * @param DBp Database represents the target database
 */
...
/**
 * @brief This method creates the detailed title
 */
...
/**
 * @brief This method constructs the main components of the title
 */
...
/**
 * @brief This method construct the main body of the window
 */
...
/**
 * @brief This class construct the component shows the ingredient amount
 */
...
/**
 * @brief This method constructs the ingredient update components
 */
...
/**
 * @brief This method constructs the components of the window shows the nutrition contents
 */
...
/**
 * @brief this class handles user's update
 */
