/**
 * A class for the Recipe detail window
 * @brief Add Recipe detail
...
/**
 * A constructor for this window
 * @brief RecipeWindow Constructor
 * @param Recipe A recipe object pointer
 * @param db A database object pointer
 * @param recipeListWindow A previous window pointer
 */
...
/**
 * A method to add a navigation bar to the window
 * @brief RecipeWindowNav
 */
...
/**
 * A method to get a navigation body
 * @brief RecipeWindowNavBody
 */
...
/**
 * A method to get the window main body
 * @brief RecipeWindowMainBody
 */
...
/**
 * A method to get the recipe information to the window
 * @brief RecipeInfo
 */
...
/**
 * A method to get the ingredient list for this recipe
 * @brief RecipeIngredientList
 */
...
/**
 * A method to get the kitchenware list for this recipe
 * @brief RecipeKitchenwareList
 */
...
/**
 * A method to get the procedure for this recipe
 * @brief RecipeProcedure
 */
...
/**
 * A method to go back to the previous page
 * @brief Back
 */
